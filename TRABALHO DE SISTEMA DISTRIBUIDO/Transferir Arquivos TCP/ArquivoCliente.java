...
public class ArquivoCliente {
	public static void main(String[] args) {
		...
		ArquivoCliente cliente = new ArquivoCliente();
	...
	private void getFileFromServeR() {
		...
		try {
			...
			fos = new FileOutputStream(new File("C://Users//PC1//Desktop//arquivo.txt"));
			
			// System.out.println("Arquivo Local Criado C://Users//PC1//Desktop//JAVA TEXTO//arquivo1.txt");
